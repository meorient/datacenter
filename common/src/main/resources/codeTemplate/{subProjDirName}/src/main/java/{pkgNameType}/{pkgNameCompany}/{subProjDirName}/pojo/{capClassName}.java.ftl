/** */
package ${pkgNameType}.${pkgNameCompany}.${subProjDirName}.pojo;
...
import ${pkgNameType}.${pkgNameCompany}.common.pojo.BasePojo;
 ...
 * @说明：<pre></pre>
 */
public class ${capClassName} extends BasePojo {
	/** 序列化UID */
