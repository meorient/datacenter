 ...
 * @项目名:common
 * @作者:chuxu
 * @日期:2019年4月22日下午4:04:45
 */
public abstract class SynchroCodeMaker {
	/** 日志 */
	 ...
	 * @retrun 项目根文件夹
	 */
	private File getDataMap(SynCodeMakerCfg param, List<ColumnInfo> columnList) {
		for (ColumnInfo colInfo : columnList) {
			setJavaClassInfo(colInfo, cfg);
		}
		ColumnInfo columnInfo = columnList.get(0);

		// userDir = E:\1_myProject\5_git\zfLendingPlatform\xdTransactionServer
		File subProjectDir = new File(System.getProperty("user.dir"));
